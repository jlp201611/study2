<%@page import="com.study.board.model.BoardSearch"%>
...
<body>
	<div class="container">
		<jsp:useBean id="boardSearch" class="com.study.board.model.BoardSearch"></jsp:useBean>
		<jsp:setProperty property="*" name="boardSearch"/>
		<%
			//BoardSearch boardSearch = new BoardSearch();
			BoardServiceImpl boardService = new BoardServiceImpl();
			boardSearch.setting(boardService.getBoardCount(boardSearch)); //pagingVo클래스에 값이 세팅되게됨
